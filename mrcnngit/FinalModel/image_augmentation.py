...
def GenerateRandomAugmentationMap(
        ...
        pScaleFactor = 0.3,        # maximum scale factor
        ...
        pBrightnessFactor = 0.4,   # maximum +- brightness
        pEnableContrast = True,     # enable contrast change
        pContrastFactor = 0.3,     # maximum +- contrast
        pEnableSharpness = True,    # enable softness/sharpness change
        pSharpnessFactor = 0.25,    # maximum +- sharpness
        ...
        pEnableInvert = False,       # enable color inversion
        pEnableColorShift = False,   # enable color shift
